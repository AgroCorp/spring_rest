...
class Users extends React.Component {
  ...
  search(page, size) {
    ...
    axios
      .post(`/auth/list-all-user?page=${page}&size=${size}`, {
    ...
    return (
      <BaseSite>
        <Container>
          <Row>
            ...
            <Col xs={8} lg={3}>
              <input
                ...
                name={"firstName"}
                onChange={(e) =>
                  (this.searchForm[e.target.name] = e.target.value)
                }
              />
            </Col>
            <Col xs={4} lg={3}>
          ...
          <Row>
            ...
            <Col xs={8} lg={3}>
              <input
                ...
                defaultChecked={true}
                onChange={(e) => {
                  this.searchForm[e.target.name] = e.target.checked;
          ...
          <Row xs={2} lg={6}>
            <Col>
              <Button variant={"primary"} onClick={this.searchButton}>
