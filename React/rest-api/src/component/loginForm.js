            ...
            <Col xs lg="3">
              <Form onSubmit={this.handleClick}>
                <FormGroup className="mb-3">
                  ...
                  <Form.Control
                    isInvalid={this.state.usernameError.length > 0}
                    isValid={this.state.usernameError.length === 0}
                    id={"username"}
                    type={"text"}
                ...
                <FormGroup className={"mb-3"}>
                  ...
                  <Form.Control
                    isInvalid={this.state.passwordError.length > 0}
                    isValid={this.state.passwordError.length === 0}
                    id={"password"}
                    type={"password"}
                    onChange={this.handleTextChange}
                    required
